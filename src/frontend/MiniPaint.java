...
public class MiniPaint extends javax.swing.JFrame {
  ...
  private void addCircle() {
    try {
      int radius = Integer.parseInt(javax.swing.JOptionPane.showInputDialog("Enter the radius of the circle").trim());
  ...
  private void addSquare() {
    try {
      int side = Integer.parseInt(javax.swing.JOptionPane.showInputDialog("Enter the side of the square").trim());
      Map<String, Double> properties = new HashMap<>();
      Square s = new Square();
  ...
  private void addRectangle() {
    try {
      int width = Integer.parseInt(javax.swing.JOptionPane.showInputDialog("Enter the width of the rectangle").trim());
      int height = Integer.parseInt(javax.swing.JOptionPane.showInputDialog("Enter the height of the rectangle").trim());
      Map<String, Double> properties = new HashMap<>();
